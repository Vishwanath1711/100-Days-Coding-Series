...
Each testcase contains a single line of input, with two space separated integers, M,H, which denote the mass and
height of Anusree respectively.
Output:
...
public class Day59 {
    public static void main(String[] args) {
        ...
        for (int i=0;i<T;i++){
            double bmi = mass[i]/(Math.pow(height[i],2));
            if (bmi<=18)
